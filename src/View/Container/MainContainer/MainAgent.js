      ...
      <Container>
        ...
        >
          <MainAgentContent 
            ...
            decs1="Database의 각종 기록(Log, 접속기록, 결재기록 등 누적데이터)를"
            decs2="이더리움 블룩체인에 매일 기록하고 수시로 변경 발생 여부를 검증하여"
            decs3="조작 발생시 이를 즉각 감지하고 변경사항을 알려주는 솔루션 입니다!"
          />
          <MainAgentContent 
            image={mainAgentDapp} 
            ...
            decs3="네트워크는 DAPP네트워크중 가장 높은 해시파워를 가지고 있습니다." 
            decs4="이는 해킹이 불가능 함을 보장합니다."
          />
          <MainAgentContent 
            image={mainAgentInfo} 
            location="Img_left"
            title="강력하고 유연한 AGENT "
            decs1="자체 개발한 BlockChain Agent는 Oracle, MySQL, MSSQL등 대부분의"
            decs2="Database 시스템을 지원하며 Java기반으로 개발되어 어떤 시스템에도"
            decs3="간편하게 설치 할 수 있습니다. 또한 3중의 Agent감시를 통해 높은"
            decs4="가용성을 보장하며 이상 징후 발생 즉시 통지 됩니다."
          />
        </Box>
      </Container>
  );
